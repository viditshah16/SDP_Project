...
client = MongoClient("mongodb+srv://bhavin07:bhavin07@chatappemojify.jacrj.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
...
def add_room_member(room_id , room_name , username , added_by , is_room_admin=False):
    room_members_collection.insert_one({'_id':{'room_id':room_id , 'username':username} ,'room_name':room_name, 'added_by':added_by , 'added_at': datetime.now() ,'is_room_admin':is_room_admin})
